...
- Cuando el archivo de entrada utilizado para la prueba en vivo fue `/srv/media/Downloads/.navigatorr-candidates/navigatorr-e2e-source...mkv`, `srcDir` ya era `.navigatorr-candidates`, lo que provocó que el candidato resultante fuera `.navigatorr-candidates/.navigatorr-candidates/...`.
