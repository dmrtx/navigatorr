...
|-------|----------|-------------|
| `service` | Yes | Service name: `sonarr`, `radarr`, `lidarr`, `readarr`, `prowlarr`, `profilarr`, `bazarr`, `seerr`, `overseerr` |
...
services:
  ...
  radarr:
    ...
    api_key: "your-api-key-here"
  # Add any: lidarr, readarr, prowlarr, profilarr, bazarr, seerr, overseerr, jellyseerr
